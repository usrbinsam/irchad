...
![IrChad Screenshot](https://github.com/usrbinsam/irchad/blob/master/screenshots/IrChad.png?raw=true){ align=center }
...
Preview builds are available for Linux and Windows.
Preview builds will connect to the IrChad test network.
Expect bugs and general unstability at this time.

[Download for](#){ .md-button .md-button--primary .download-btn }

## Features

|              | Windows            | Linux              | macOS              |
| ------------ | ------------------ | ------------------ | ------------------ |
| Chat         | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| Voice        | :white_check_mark: | :white_check_mark: | -                  |
| Camera       | -                  | :white_check_mark: | -                  |
| Screen Share | :white_check_mark: | :white_check_mark: | -                  |
